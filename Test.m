function Test(Daten)
  ...
  % mit den kalkulierten Daten wird die Graphik für die vorhergesagten Werte
  % erstellt
  ...
  counts=Daten(7:42,:);
  Panel_Vorhersage=uipanel(fi,'title','Vorhersage','units','normalized',...
                   'position',[0.1 0 0.8 0.6]);
  % die Position des Balkendiagramms innerhalb des GUI's wird definiert
  ax=axes(Panel_Vorhersage);
