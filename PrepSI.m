  ...
  pun=A{52};
  thr=A{53};
  Spielerliste=[UID,UID,UID,UID,Age,CA,PA,Value,cor,cro,dri,fin,fir,fre,hea,loS,loT,mar,pas,pen,...
    tac,tec,agg,ant,bra,coP,con,vis,dec,det,fla,lea,off,pos,tea,wor,acc,agi,bal,jum,nat,...
    pac,sta,str,aer,coA,kic,one,ref,ecc,rus,pun,thr];
